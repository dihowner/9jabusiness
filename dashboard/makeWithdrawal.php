...
<head>
  ...
  <title>9jaBusiness - Make Withdrawal</title>
  <!-- loader--
  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
         <div class="card">
           <div class="card-body">
           <div class="card-title" style="font-size: 20px">Withdraw Fund</div>
           <p style="font-size: 18px;">Your wallet balance is <b>&dollar;<?php echo number_format($action->userWallet($userid)["usd"], 2);?></b></p> <hr>
			...
			<p style="font-size: 18px;">Kindly fill the form below to make a withdrawal request </p><br/>
			
			<form method="post">
			
				<div class="form-group row">
					<div class="col-lg-12">
						<label for="input-1">Amount to withdraw</label>
				...
				<div class="form-group row">
					<div class="col-lg-12">
						<label for="input-1">Select Payment Method</label>
						<select class="form-control" id="payMethod" name="payMethod" required>
							...
							<option value="bank">Bank Account (Naira Wallet)</option>
						</select>
					</div>
				</div>
				...
				<div class="form-group row">
					<div class="col-lg-12">
						...
						<input class="form-control" type="password" placeholder="Enter your account password" name="accntPass" id="accntPass">
					</div>
				</div>
			
				<div class="form-group row">
					<div class="col-lg-12">
						<b style="color: #f5a21b">NOTE:</b> Minimum withdrawal is <b>&dollar;<?php echo number_format($action->withdrawSettings()->min_withdrawal, 2);?></b> and Maximum is <b>&dollar;<?php echo number_format($action->withdrawSettings()->max_withdrawal, 2);?></b>
					</div>
				</div>
				
				<div class="form-group">
					<button type="submit" class="btn btn-light px-5" name="mkWithdraw" id="mkWithdraw"><i class="fa fa-exchange"></i> Submit Request</button>
				</div>
			</form>
