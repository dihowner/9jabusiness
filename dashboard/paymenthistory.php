           ...
           <hr>
			<div class="table-responsive">
				<table class="table table-bordered table-striped">
					...
					<tr>
					 <?php $i = 1;
					   $loadTran = $action->query("select * from payment where (status!=5 and status!=0) order by id desc limit $start_page, $per_page"); $loadTran->execute();
					   ...
					   ?>
						   ...
						   <td>
							<?php if($loadTrans["status"] == 1) { ?>
								<span class="badge badge-success" style="padding: 15px">Success</span>
							<?php } else if($loadTrans["status"] == 3) { ?>
								<span class="badge badge-danger" style="padding: 15px">Rejected</span>
							<?php } else if($loadTrans["status"] == 2) { ?>
								<span class="badge badge-warning" style="padding: 15px">Awaiting Approval</span>
							<?php } else { ?>
				...
				<div class="text-center" style="margin-top: 2%">
					<?php echo $action->paginate("", "select * from payment where (status!=5 and status!=0) order by id desc");?>
				</div>
