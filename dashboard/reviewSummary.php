...
<head>
  ...
  <title>9jaBusiness - Business Review Summary</title>
  <!-- loader--
  ...
  <div class="content-wrapper">
    ...
    <div class="row mt-3">
      <div class="col-lg-12">
         <div class="card">
           <div class="card-body">
           <div class="card-title" style="font-size: 20px">Reviewed Business History</div>
           ...
           <hr>
            ...
            <th>Status </th> 
             <th> </th>
					...
					<tr>
					 <?php $i = 1;
					     $usr = $action->query("SELECT * FROM `businessreview` where userid='$userid' order by id desc limit $start_page, $per_page");
              $usr->execute();
                  ...
                  $message = $usrInfo["message"];
                    ...
                    if($rev_Status == 0) {
                        ...
                        $review_status = "<span class='text-danger'><b>Rejected</b></span>";
                    }   else {
                        $review_status = "";
                    }
                    
                    //Search business creation...
                    $srchBus2 = $action->query("select * from businesscreation where id='$bus_id'"); $srchBus2->execute();
              ...
              <div class="modal fade" id="userid<?php echo $id;?>" style='margin-top: 40px;'>
				...
				<div class="text-center" style="margin-top: 2%">
					<?php echo $action->paginate("", "select * from businessreview where userid='$userid' order by id desc");?>
				</div>
